...
This repository is modified version of the [original Github repository](https://github.com/n3d1117/chatgpt-telegram-bot.git).


> 1. Get your OpenAI API key from [here](https://platform.openai.com/api-keys) and TELEGRAM_BOT_TOKEN using @BotFather then paste them into `.env` file.
> 2. Run `pip install -r requirements.txt`
> 3. Start the bot with `python bot/main.py`
...
```shell
git clone https://github.com/anhnb206110/chatGPT-telegram-bot.git
